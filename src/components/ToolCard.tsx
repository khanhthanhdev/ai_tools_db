...
export function ToolCard({ tool, language, showScore = false }: ToolCardProps) {
  ...
  return (
    ...
    >
      <Card
        className={cn(
          "group/card relative w-full h-full min-h-[340px] sm:min-h-[380px]",
          "overflow-hidden",
        ...
        <CardContent className="relative flex h-full flex-col p-3 sm:p-4">
          ...
          <div className="flex gap-2 mt-auto">
            <Button
              ...
              variant="default"
              size="default"
              className="flex-1 group/btn relative overflow-hidden shadow-md hover:shadow-xl transition-all duration-300"
            >
            ...
            <ToolDetailDrawer tool={tool} language={language}>
              <Button
                variant="outline"
                size="default"
                className="group/btn relative overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
              >
